...
| [String To Integer (atoi)](https://github.com/maikelsalazar/leetcode-java/tree/main/src/main/java/com/maikelsalazar/leetcode/strintointatoi)         | [StringToIntAtoi.java](https://github.com/maikelsalazar/leetcode-java/blob/main/src/main/java/com/maikelsalazar/leetcode/strintointatoi/StringToIntAtoi.java) | [StringToIntAtoiTest.java](https://github.com/maikelsalazar/leetcode-java/blob/main/src/test/java/com/maikelsalazar/leetcode/strintointatoi/StringToIntAtoiTest.java)  | Solved without using exceptions; `null → NullPointerException`.                                   |
